...
class NotificationServiceImplTest {
	...
	void shouldLimpezaNotifActiveTrueNotifNameNull() throws IllegalAccessException {
		setNotifActive();
		Assertions.assertThrows(ListBuilderException.class, () -> service.limpeza(dtoLimpeza, LAYOUT2));
	}
	...
	void shouldVidaCristaNotifActiveTrueNotifNameNull() throws IllegalAccessException {
		setNotifActive();
		Assertions.assertThrows(ListBuilderException.class, () -> service.vidaCrista(dtoVidaCrista));
	}
	...
	void shouldVidaCristaMidweekMeetingDayNullException() throws IllegalAccessException {
		...
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.vidaCrista(dtoVidaCrista));
		Assertions.assertEquals("Propriedade 'notif.christianlife.midweek.meeting.day' não é um Dia da Semana Válido!", ex.getMessage());
	}
	...
	void shouldVidaCristaMidweekMeetingDayInvalidException() throws IllegalAccessException {
		...
		setNotifName(name);
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.vidaCrista(dtoVidaCrista));
		Assertions.assertEquals("Defina a propriedade 'notif.christianlife.midweek.meeting.day'!", ex.getMessage());
	}
