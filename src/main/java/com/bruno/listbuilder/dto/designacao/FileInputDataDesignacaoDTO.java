package com.bruno.listbuilder.dto.designacao;
...
import com.bruno.listbuilder.dto.BaseFileInputDataDTO;
...
public class FileInputDataDesignacaoDTO extends BaseFileInputDataDTO {
	...
	private List<@Valid @NotBlank(message = MessageConfig.INDICATOR_ELEMENT_REQUIRED) String> indicator;
	
	@NotEmpty(message = MessageConfig.MICROPHONE_REQUIRED)
	@SerializedName("microfone")
	private List<@Valid @NotBlank(message = MessageConfig.MICROPHONE_ELEMENT_REQUIRED) String> microphone;
