...
public final class MessageConfig {
    ...
    // Generic
    public static final String MSG_ERROR_MIDWEEK_DAY_NOT_FOUND =
            "Dia da Reunião de Meio de Semana está VAZIO!";
    public static final String MSG_ERROR_WEEKEND_DAY_NOT_FOUND =
            "Dia da Reunião de Fim de Semana está VAZIO!";
    public static final String LAST_DATE_REQUIRED =
            "Campo 'ultimaData' da Lista Anterior é obrigatório!";
    ...
    public static final String FILE_SYNTAX_ERROR =
            "Erro ao ler arquivo - Arquivo não é um JSON válido";
    ...
    public static final String INDICATOR_ELEMENT_REQUIRED =
            "Item da lista de 'indicador' não pode ser Nulo/Vazio/Branco!";
    public static final String MICROPHONE_REQUIRED = "Campo 'microfone' é obrigatório!";
    public static final String MICROPHONE_ELEMENT_REQUIRED =
            "Item da lista de 'microfone' não pode ser Nulo/Vazio/Branco!";

    // Designations Generic
    public static final String LIST_REQUIRED = "Campo 'lista' é obrigatório!";
    public static final String LIST_ELEMENT_REQUIRED =
            "Item da lista não pode ser Nulo/Vazio/Branco!";
    public static final String LAST_REQUIRED = "Campo 'ultimo' é obrigatório!";
    public static final String LAST_INVALID =
            "Último %s informado não corresponde a nenhum da Lista!";

    // Clearing
    public static final String LAST_GROUP_INVALID =
            "Último Grupo informado não corresponde a nenhum Grupo da Lista!";
