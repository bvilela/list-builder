...
public class DateServiceImpl implements DateService {
    ...
    private List<ItemDateDTO> generateListDates(DateServiceInputDTO dto, int monthsToAdd) {
        ...
        while (toContinue) {
            nextDate =
                    getNextDate(dto.getMidweekDayWeekEnum(), dto.getWeekendDayWeekEnum(), nextDate);
    ...
    private LocalDate getNextDate(
            DayOfWeekEnum midweekEnum, DayOfWeekEnum weekendEnum, LocalDate date) {
    ...
    private void addDatesExceptions(
            DateServiceInputDTO dto,
            List<LocalDate> listDatesAddOrdered,
            List<ItemDateDTO> listDates,
            LocalDate nextDate) {
    ...
    private void removeDatesExceptions(
            DateServiceInputDTO dto, List<ItemDateDTO> listDates, LocalDate nextDate) {
