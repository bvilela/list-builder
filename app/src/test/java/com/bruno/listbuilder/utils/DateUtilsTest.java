...
class DateUtilsTest {
	...
	void shouldNextDayOfWeek() {
		Assertions.assertEquals(LocalDate.of(2022, 06, 13), DateUtils.nextDayOfWeek(LocalDate.of(2022, 06, 10), DayOfWeek.MONDAY));
		Assertions.assertEquals(LocalDate.of(2022, 06, 17), DateUtils.nextDayOfWeek(LocalDate.of(2022, 06, 10), DayOfWeek.FRIDAY));
		Assertions.assertEquals(LocalDate.of(2022, 07, 05), DateUtils.nextDayOfWeek(LocalDate.of(2022, 06, 30), DayOfWeek.TUESDAY));
	}
	...
	private void checkMonth(int value, String monthName) {
		Assertions.assertEquals(value, DateUtils.getMonthByNamePT(StringUtils.capitalize(monthName)).getValue());
		Assertions.assertEquals(value, DateUtils.getMonthByNamePT(monthName.toLowerCase()).getValue());
		Assertions.assertEquals(value, DateUtils.getMonthByNamePT(monthName.toUpperCase()).getValue());
	}
	...
	void shouldFormatDDMMMM() {
		...
		Assertions.assertEquals("02 de fevereiro", DateUtils.formatDDMMMM(LocalDate.of(2022, 2, 2)));
		...
		Assertions.assertEquals("10 de outubro", DateUtils.formatDDMMMM(LocalDate.of(2022, 10, 10)));
		Assertions.assertEquals("11 de novembro", DateUtils.formatDDMMMM(LocalDate.of(2022, 11, 11)));
		Assertions.assertEquals("12 de dezembro", DateUtils.formatDDMMMM(LocalDate.of(2022, 12, 12)));
	}
