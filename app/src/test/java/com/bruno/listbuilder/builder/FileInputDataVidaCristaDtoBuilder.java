...
public class FileInputDataVidaCristaDtoBuilder {
	...
	public FileInputDataVidaCristaDtoBuilder withRandomData() {
		this.withAbbreviations(Map.of(RandomStringUtils.randomAlphabetic(2), RandomStringUtils.randomAlphabetic(15),
				RandomStringUtils.randomAlphabetic(2), RandomStringUtils.randomAlphabetic(15),
				RandomStringUtils.randomAlphabetic(2), RandomStringUtils.randomAlphabetic(15)
		));
		...
		this.withParticipants(List.of(
				...
				List.of(RandomStringUtils.randomAlphabetic(2), RandomStringUtils.randomAlphabetic(2)),
				List.of(RandomStringUtils.randomAlphabetic(2)),
				List.of(RandomStringUtils.randomAlphabetic(2), RandomStringUtils.randomAlphabetic(2))
		));
		return this;
	...
	public FileInputDataVidaCristaDtoBuilder withRemoveWeekFromList(Map<String, String> removeFromList) {
		this.target.setRemoveWeekFromList(removeFromList);
		return this;
	}
	
	public FileInputDataVidaCristaDtoBuilder withRenameItems(List<FileInputDataVidaCristaRenameItemDTO> renameItems) {
