...
class VidaCristaWriterServiceImplTest {
	...
	void shouldGetImageByLabelException() throws ListBuilderException {
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.getImageNameByLabel("invalid"));
		Assertions.assertEquals("Erro ao obter Imagem da Label - Nenhuma Imagem encontrada para a Label", ex.getMessage());
	}
