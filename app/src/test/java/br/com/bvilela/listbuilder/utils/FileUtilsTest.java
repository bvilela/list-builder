...
class FileUtilsTest {
    ...
    void shouldGenerateOutputFileNameDesignacaoPDF() {
        var name =
                FileUtils.generateOutputFileNamePDF(
                        ListTypeEnum.DESIGNACAO, LocalDate.of(2022, 11, 1));
    ...
    void shouldGenerateOutputFileNameDesignacaoDocx() {
        var name =
                FileUtils.generateOutputFileNameDocx(
                        ListTypeEnum.DESIGNACAO, LocalDate.of(2022, 12, 1));
    ...
    void shouldGenerateOutputFileNameDiscursoPDF() {
        var name =
                FileUtils.generateOutputFileNamePDF(
                        ListTypeEnum.DISCURSO, LocalDate.of(2022, 1, 10));
    ...
    void shouldGenerateOutputFileNameDiscursoDocx() {
        var name =
                FileUtils.generateOutputFileNameDocx(
                        ListTypeEnum.DISCURSO, LocalDate.of(2022, 2, 10));
    ...
    void shouldGenerateOutputFileNameLimpezaPDF() {
        var name =
                FileUtils.generateOutputFileNamePDF(ListTypeEnum.LIMPEZA, LocalDate.of(2022, 3, 1));
    ...
    void shouldGenerateOutputFileNameLimpezaDocx() {
        var name =
                FileUtils.generateOutputFileNameDocx(
                        ListTypeEnum.LIMPEZA, LocalDate.of(2022, 3, 1));
    ...
    void shouldGenerateOutputFileNameVidaCristaPDF() {
        var name =
                FileUtils.generateOutputFileNamePDF(
                        ListTypeEnum.VIDA_CRISTA, LocalDate.of(2022, 3, 10));
    ...
    void shouldGenerateOutputFileNameVidaCristaDocx() {
        var name =
                FileUtils.generateOutputFileNameDocx(
                        ListTypeEnum.VIDA_CRISTA, LocalDate.of(2022, 4, 10));
