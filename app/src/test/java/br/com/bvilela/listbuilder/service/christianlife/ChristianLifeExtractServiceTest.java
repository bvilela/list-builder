...
class ChristianLifeExtractServiceTest {
    ...
    void shouldExtractWeeksBySite() {
        ...
        checkWeekItem(
                ...
                ChristianLifeExtractItemTypeEnum.PRESIDENT,
                "Presidente da Reunião");
        checkWeekItem(
                week.getItems().get(index++),
                ChristianLifeExtractItemTypeEnum.READ_OF_WEEK,
                "1 SAMUEL 27-29");
        checkWeekItem(
                week.getItems().get(index++),
        ...
        checkWeekItem(
                week.getItems().get(index++),
                ChristianLifeExtractItemTypeEnum.NO_PARTICIPANTS,
                "Comentários iniciais");
        checkWeekItem(
                week.getItems().get(index++),
                ChristianLifeExtractItemTypeEnum.LABEL,
