...
public class DesignacaoWriterDtoBuilder {
    ...
    public DesignacaoWriterDtoBuilder withReaderWatchtower(List<DesignacaoWriterItemDTO> readerWatchtower) {
        this.target.setReaderWatchtower(readerWatchtower);
        return this;
    }
    
    public DesignacaoWriterDtoBuilder withReaderBibleStudy(List<DesignacaoWriterItemDTO> readerBibleStudy) {
