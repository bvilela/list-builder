...
class GroupServiceImplTest {
	...
	void shouldGenerateListGroupExceptionLastGroupInvalid() throws IllegalAccessException, ListBuilderException {
		...
		var ex = Assertions.assertThrows(ListBuilderException.class,
	...
	void shouldgenerateListDesignacaoPresidentException() throws IllegalAccessException, ListBuilderException {
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.generateListPresident(null, null));
	...
	void shouldgenerateListDesignacaoPresidentLastInvalidException() throws IllegalAccessException, ListBuilderException {
		...
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.generateListPresident(dto, listLocalDate));
		Assertions.assertTrue(ex.getMessage().contains(String.format(MessageConfig.LAST_INVALID, DesignacaoEntityEnum.PRESIDENT.getLabel())));
	}
	...
	void generateListDesignacaoReaderWatchtowerException() throws IllegalAccessException, ListBuilderException {
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.generateListReaderWatchtower(null, null));
		Assertions.assertTrue(ex.getMessage().contains(DesignacaoEntityEnum.READER_WATCHTOWER.getLabel()));
	}
	...
	void shouldgenerateListDesignacaoReaderWatchtowerLastInvalidException() throws IllegalAccessException, ListBuilderException {
		...
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.generateListReaderWatchtower(dto, listLocalDate));
		Assertions.assertTrue(ex.getMessage().contains(String.format(MessageConfig.LAST_INVALID, DesignacaoEntityEnum.READER_WATCHTOWER.getLabel())));
	}
	...
	void generateListDesignacaoReaderBibleStudyException() throws IllegalAccessException, ListBuilderException {
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.generateListReaderBibleStudy(null, null));
		Assertions.assertTrue(ex.getMessage().contains(DesignacaoEntityEnum.READER_BIBLESTUDY.getLabel()));
	}
	...
	void shouldgenerateListDesignacaoReaderBibleStudyLastInvalidException() throws IllegalAccessException, ListBuilderException {
		...
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.generateListReaderBibleStudy(dto, listLocalDate));
		Assertions.assertTrue(ex.getMessage().contains(String.format(MessageConfig.LAST_INVALID, DesignacaoEntityEnum.READER_BIBLESTUDY.getLabel())));
	}
	...
	void generateListDesignacaoAudioVideoException() throws IllegalAccessException, ListBuilderException {
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.generateListAudioVideo(null, null));
	...
	void shouldgenerateListDesignacaoAudioVideoSuccess() throws IllegalAccessException, ListBuilderException {
		...
		Assertions.assertEquals(4, list.size());
		Assertions.assertTrue(dto.getAudioVideo().getList().get(1).contains(list.get(0).getName().split(" e ")[0]));
		Assertions.assertTrue(dto.getAudioVideo().getList().get(2).contains(list.get(1).getName().split(" e ")[0]));
		Assertions.assertTrue(dto.getAudioVideo().getList().get(3).contains(list.get(2).getName().split(" e ")[0]));
		Assertions.assertTrue(dto.getAudioVideo().getList().get(0).contains(list.get(3).getName().split(" e ")[0]));
	}
	...
	void shouldgenerateListDesignacaoAudioVideoLastInvalidException() throws IllegalAccessException, ListBuilderException {
		...
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.generateListAudioVideo(dto, listLocalDate));
		Assertions.assertTrue(ex.getMessage().contains(String.format(MessageConfig.LAST_INVALID, DesignacaoEntityEnum.AUDIOVIDEO.getLabel())));
	}
	...
	void generateListDesignacaoIndicatorException() throws IllegalAccessException, ListBuilderException {
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.generateListIndicator(null, null, null));
	...
	void generateListDesignacaoMicrophoneException() throws IllegalAccessException, ListBuilderException {
		var ex = Assertions.assertThrows(ListBuilderException.class, () -> service.generateListMicrophone(null, null, null));
