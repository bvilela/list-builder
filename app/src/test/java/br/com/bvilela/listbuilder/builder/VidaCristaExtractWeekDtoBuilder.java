...
public class VidaCristaExtractWeekDtoBuilder {
	...
	private VidaCristaExtractWeekDtoBuilder base(LocalDate date1, LocalDate date2) {
		...
		this.withItems(List.of(
				VidaCristaExtractWeekItemDtoBuilder.create().withRandomData(VidaCristaExtractItemType.READ_OF_WEEK)
						.build(),
				VidaCristaExtractWeekItemDtoBuilder.create().withRandomData(VidaCristaExtractItemType.PRESIDENT)
						.build(),
				VidaCristaExtractWeekItemDtoBuilder.create().withRandomData(VidaCristaExtractItemType.LABEL)
						.withTitle("TESOUROS DA PALAVRA").build(),
				VidaCristaExtractWeekItemDtoBuilder.create().withRandomData(VidaCristaExtractItemType.LABEL)
						.withTitle("FAÇA SEU MELHOR").build(),
				VidaCristaExtractWeekItemDtoBuilder.create().withRandomData(VidaCristaExtractItemType.LABEL)
						.withTitle("NOSSA VIDA CRISTÃ").build(),
				VidaCristaExtractWeekItemDtoBuilder.create().withRandomData(VidaCristaExtractItemType.NO_PARTICIPANTS)
						.build(),
				VidaCristaExtractWeekItemDtoBuilder.create().withRandomData(VidaCristaExtractItemType.WITH_PARTICIPANTS)
						.build()));
		return this;
	}
